...
app.config['SECRET_KEY'] = 'adb7c7b0421da648000d8f3a5797fb74cee4e15374090c95a9159396f6920f60'
...
def send_otp_email(to_email, otp):
    msg = MIMEMultipart()
    msg['From'] = 'abdulrayan2003@gmail.com'
    msg['To'] = to_email
...
""".format(otp)
    ...
    server.login('abdulrayan2003@gmail.com', 'tihddhevxewznlwu')
...
def send_new_course_email( email_content):
    ...
    app_password = 'tihddhevxewznlwu'# Your app-specific password
...
def start_npm():
    try:
        ...
        frontend_project_path = r'C:\Users\abdul\OneDrive\Desktop\onlinelearningplatform-main\templates'
